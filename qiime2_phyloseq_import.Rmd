...
(p <- plot_richness(ps, x = "diet_group", color = "sex", measures = c("Observed", "Chao1", "Shannon")))

(p1 <- plot_richness(ps1, x = "diet_group", color = "sex", measures = c("Observed", "Chao1", "Shannon")))

(p2 <- plot_richness(ps2, x = "diet_group", color = "sex", measures = c("Observed", "Chao1", "Shannon")))

p + labs(x = "", y = "\nAlpha Diversity Measure (p) \n") + 
  theme_bw()
p1 + labs(x = "", y = "\nAlpha Diversity Measure (p1) \n") + 
  theme_bw()
p2 + labs(x = "", y = "\nAlpha Diversity Measure (p2)\n") + 
  theme_bw()
